...
vim.keymap.set('n', '<leader>bn', '<cmd>BufferNext<cr>', BUFFER_OPTS)
vim.keymap.set('n', '<leader>bp', '<cmd>BufferPrevious<cr>', BUFFER_OPTS)

vim.keymap.set('n', '<leader>bN', '<cmd>BufferMoveNext<cr>', BUFFER_OPTS)
vim.keymap.set('n', '<leader>bP', '<cmd>BufferMovePrevious<cr>', BUFFER_OPTS)

vim.keymap.set('n', '<leader>bs', '<cmd>BufferOrderByLanguage<cr>', BUFFER_OPTS)
